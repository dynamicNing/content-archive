...
└── research/           📊 投研报告（无明确分类的调研报告默认归档至此）
```
...
## research/ 归档规则（2026-04-26 起）

投研报告默认归档至此，无明确分类的调研报告均放此。
...
| `research/` | 投研报告 | 按需生成（Nomi / stock-research-engine） |

## 同步规则

- **ai-digest / economic-policy / skill-updates / research**：通过 `content-sync.sh` 自动推送 PR 合并至 master
